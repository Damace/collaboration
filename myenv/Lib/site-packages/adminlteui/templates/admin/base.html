    ...
    {% if not is_popup %}
        <header class="main-header">
            ...
            <a href="{% url 'admin:index' %}" class="logo">
              ...
              <span class="logo-lg">
                {% if adminlte.site_logo %}
                    {% comment %} <img src="{{ adminlte.site_logo }}" class="user-image" alt="User Image" style="width:45px;height:45px;padding:5px;">
               {% endcomment %}
               <label style="width:85px;height:45px;padding:5px;"></label>
                    {% else %}
                    {% comment %} <img src="{% static "admin/dist/img/default-log.svg" %}" class="user-image" alt="User Image" > {% endcomment %}
                    <small>A T S</small>
                    {% endif %}
                    {% comment %} <b>{{ site_header }}</b> {% endcomment %}
                 </span> 
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        {% comment %} <a href="{% url 'admin_logout' %}" class="btn btn-default btn-flat">{% trans 'logout' %}</a> {% endcomment %}

                                        {% comment %} <a href="{% url 'admin:custom_logout' %}" class="btn btn-default btn-flat">{% trans 'Log out' %}</a> {% endcomment %}
                                   
                                        <a href="{% url 'admin_logout' %}" class="btn btn-default btn-flat">{% trans 'Log out' %}</a>
