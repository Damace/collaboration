...
TEMPLATES = [
    {
        ...
        # 'DIRS': [],
        'DIRS': [BASE_DIR / "templates",os.path.join(BASE_DIR, 'admission/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                # 'django_adminlte_ui.context_processors.adminlte',
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Kondoa High",
    "site_header": "your_site_header",
    "site_brand": "Kondoa High",
